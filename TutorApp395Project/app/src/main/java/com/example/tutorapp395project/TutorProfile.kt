...
import com.example.tutorapp395project.databinding.ActivityTutorProfileBinding
...
class TutorProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_tutor_profile)
